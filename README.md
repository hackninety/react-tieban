...
- **大限流年细节** 排盘页内：流年表按**大限分段**（童限 + 十年一柱组头，子平起运口径——
  阳男阴女顺排/阴男阳女逆排自月柱、节气距三日折一年，lunar-typescript 计算；铁板原文无大运取数，
  仅作分限参考并明示）；每行附**公历年份**；求测时刻的**当前虚岁**行朱色衬底；
  基础排盘补**天地数**（八字太玄奇偶分和，天基 25 地基 30 取余）、**上运时间**与**四柱六亲宫位**
  （年父母/月兄弟/日夫妻/时子女）
